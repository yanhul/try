...
Providers propose; local validation is authoritative. No OOS data enters the
prompt, and malformed provider output is never registered as a candidate.
"""
...
def main():
    ...
    for name in order:
        try:
            ...
            # Compute and inject the authoritative hash before persistence.
