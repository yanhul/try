...
# Zero cost is retained only as a gross research diagnostic. It is never a net-executable gate.
EVALUATION_SPEC={"stop_fraction":0.01,"reward_multiple":2.0,"round_trip_cost":0.0,"cost_model_status":"UNAVAILABLE"}
