...
Evaluation parameters are governing criteria and are intentionally immutable at
runtime. OOS is deliberately never touched here. Promotion is decided only from
IS/Validation produced under the frozen evaluation spec.
"""
...
# Governing evaluation criteria. Do not expose these as agent-controlled CLI
# parameters: changing them requires a reviewed source change.
EVALUATION_SPEC = {
    "stop_fraction": 0.01,
    "reward_multiple": 2.0,
    "round_trip_cost": 0.0,
...
def main() -> int:
    ...
    is_result=evaluate_split(
        ...
        EVALUATION_SPEC['round_trip_cost'])
